#include "stdafx.h"
#include "VstProgramSaver.h"
#include <fstream>

VstProgramSaver::VstProgramSaver(const char * fxID, const char * fxVersion, int numParams, const char * fileName, const char * name, int nameLength, float* params){
...
VstProgramSaver::~VstProgramSaver(){
	delete program;
	output.close();
}

char * VstProgramSaver::intToChar(int i) {
